...
result (res)
 ...
 type(subRegion_type) :: res !< What is returned
  res%grid_type = diag_files_obj%file_sub_region%grid_type
  if (allocated(diag_files_obj%file_sub_region%corners)) &
    res%corners = diag_files_obj%file_sub_region%corners
    res%tile = diag_files_obj%file_sub_region%tile
