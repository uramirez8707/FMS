...
result (res)
 ...
 type(subRegion_type) :: res !< What is returned
  res%grid_type = this%file_sub_region%grid_type
  if (allocated(this%file_sub_region%corners)) &
    res%corners = this%file_sub_region%corners
  res%tile = this%file_sub_region%tile
