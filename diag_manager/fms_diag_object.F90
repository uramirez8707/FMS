...
subroutine fms_register_diag_field_obj &
                !(dobj, modname, varname, axes, time, longname, units, missing_value, attributes)
...
#endif
!> @brief Checks if obj%attributes is allocated
!! @return true if obj%attributes is allocated
