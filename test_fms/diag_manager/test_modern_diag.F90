...
integer :: id_x, id_y, id_z, id_sst, id_ice, id_dummy
logical :: used
...
if (id_x .ne. 1) call mpp_error(FATAL, "x should have an id of 1!")
print *, "id_x ", id_x

id_y  = diag_axis_init('y',  y,  'point_N', 'y', long_name='point_N', Domain2=Domain)
if (id_y .ne. 2) call mpp_error(FATAL, "y should have an id of 2!")
print *, "id_y ", id_y

id_z  = diag_axis_init('z',  z,  'point_Z', 'z', long_name='point_Z')
if (id_z .ne. 3) call mpp_error(FATAL, "x should have an id of 3!")
print *, "id_z ", id_z

id_sst = register_diag_field  ('test_diag_manager_mod', 'sst', (/id_x,id_y,id_z/), Time, 'SST', 'K')
if (id_sst .ne. 1) call mpp_error(FATAL, "sst should have an id of 1!")
print *, "id_sst ", id_sst

id_ice = register_diag_field  ('test_diag_manager_mod', 'ice', (/id_x,id_y/), Time, 'ICE', 'm')
if (id_ice .ne. 2) call mpp_error(FATAL, "ice should have an id of 2!")
print *, "id_ice ", id_ice

id_dummy = register_diag_field  ('test_diag_manager_mod', 'dummy', (/id_x,id_y/), Time, 'ICE', 'm')
if (id_dummy .ne. -999) call mpp_error(FATAL, "dummy should not have a valid id!")
print *, "id_dummy ", id_dummy
